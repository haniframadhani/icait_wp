			...
			<div class="h-full w-full place-content-center bg-black/20">
				<div class="mx-auto mt-[4.5rem] grid max-w-screen-xl">
					<div class="text-center">
						<p class="mb-2 text-sm text-slate-50 md:text-base">10-11 September 2025, Yogyakarta, Indonesia</p>
						...
						<p class="mb-4 text-base italic tracking-wide text-slate-50 md:text-xl">"Artificial Intelligence
							Applications for a Prosperous and Sustainable Living in the Modern Society"</p>
		...
		<div class="mx-auto max-w-screen-xl">
			...
			<div class="flex w-full flex-col items-center gap-5 md:flex-row">
				...
				<div class="flex flex-col md:w-[60%] lg:w-[70%]">
					<p class="text-base font-normal md:text-xl">The International Conference on Artificial Intelligence Technology
						(ICAIT) aims at becoming a venue to deliver and to communicate recent progress of the artificial
						intelligence research and its applications in various domains, as well as bringing together scholars and
						practitioners to disseminate and discuss the ongoing research in the field of Artificial Intelligence.</p>
					<p class="mt-7 text-base font-normal md:text-xl">The 1<sup>st</sup> ICAIT (ICAIT2025) will be held in
						Yogyakarta, Indonesia on 10<sup>th</sup> - 11<sup>th</sup> September, 2025. It is conducted by the
						Artificial Intelligence Research Group of the Informatics Department, Faculty of Industrial Technology,
						Universitas Ahmad Dahlan, Indonesia. The 1<sup>st</sup> ICAT is held on the theme of "Artificial
						Intelligence Applications for a Prosperous and Sustainable Living in the Modern Society."</p>
				</div>
			</div>
		</div>
	</section>
