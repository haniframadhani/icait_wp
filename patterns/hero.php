    ...
    <div class="h-full w-full place-content-center bg-black/20">
      <div class="mx-auto mt-[4.5rem] grid max-w-screen-xl">
        <div class="text-center">
          <!-- /wp:html -->
          <!-- wp:paragraph {"className":"mb-2 text-sm text-slate-50 md:text-base"} -->
          <p class="mb-2 text-sm text-slate-50 md:text-base">10-11 September 2025, Yogyakarta, Indonesia
            &#40;Hybrid&#41;</p>
          <!-- /wp:paragraph -->
          <!-- wp:heading {"level":1,"className":"mb-2 text-3xl font-bold leading-tight tracking-wide text-slate-50 md:text-4.5xl"} -->
          ...
          <!-- /wp:heading -->
          <!-- wp:paragraph {"className":"mb-4 text-base italic tracking-wide text-slate-50 md:text-xl"} -->
          ...
          <!-- /wp:paragraph -->
          <!-- wp:paragraph {"className":"mb-1 text-sm text-slate-50 md:text-base"} -->
