...
<section class="p-6" id="forauthor">
  <div class="mx-auto max-w-screen-xl">
    <div class="flex gap-1 mb-6 text-slate-900">
      ...
      <!-- /wp:html -->
      <!-- wp:heading {"className":"text-4xl font-medium"} -->
    ...
    <div class="flex flex-col gap-8 md:flex-row">
      <div class="w-full md:w-2/5">
        <div class="flex gap-1 mb-2 text-slate-900">
          ...
          <!-- /wp:html -->
          <!-- wp:heading {"level":3, "className":"text-2xl font-medium"} -->
        ...
        <div class="relative overflow-x-hidden px-[120px] md:px-[150px]">
          <!-- /wp:html -->
          <!-- wp:list {"ordered":true,"className":"flex flex-col"} -->
          <ol class="flex flex-col">
            <!-- wp:list-item {"className":"relative flex flex-col p-6 pt-0"} -->
            <li class="relative flex flex-col p-6 pt-0">
              <!-- wp:html -->
              <div class="left-7.5 absolute top-0.5 h-full w-px -translate-x-1/2 translate-y-2 bg-san-juan-700"></div>
              <div class="flex items-start gap-4">
                <!-- /wp:html -->
                <!-- wp:paragraph {"className":"overflow-wrap absolute w-[130px] -translate-x-36 break-words text-right text-secondary-foreground md:w-[130px] text-sm leading-3.5 font-semibold tracking-tight"} -->
                <p
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3, "className":"w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight"} -->
            ...
            <li class="relative flex flex-col p-6 pt-0">
              ...
              <div class="flex items-start gap-4">
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3, "className":"w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight"} -->
                <h3 class="w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight">Camera
                  Ready</h3>
                <!-- /wp:heading -->
                <!-- wp:html -->
              </div>
            ...
            <li class="relative flex flex-col p-6 pt-0">
              ...
              <div class="flex items-start gap-4">
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3, "className":"w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight"} -->
                <h3 class="w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight">Normal
            ...
            <li class="relative flex flex-col p-6 pt-0">
              ...
              <div class="flex items-start gap-4">
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3, "className":"w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight"} -->
                <h3 class="w-[150px] text-secondary-foreground text-sm leading-3.5 font-semibold tracking-tight">One day
                  tour</h3>
                <!-- /wp:heading -->
                <!-- wp:html -->
              </div>
      ...
      <div class="w-full space-y-8 md:w-3/5">
        <div class="space-y-2">
          ...
          <!-- /wp:html -->
          <!-- wp:list {"ordered":true,"className":"w-full list-decimal pl-6 text-base md:text-lg"} -->
        ...
        <div class="space-y-2">
          ...
          <!-- /wp:html -->
          <!-- wp:paragraph {"className":"text-base md:text-lg"} -->
