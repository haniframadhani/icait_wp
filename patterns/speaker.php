      ...
      <div
        ...
        <div class="mb-2 w-full">
          <img src="<?= bloginfo('template_directory') ?>/assets/images/speaker-1.webp"
            alt="Prof. Dr-Ing. Hendro Wicaksono" loading="lazy" width="232" height="330" decoding="async" data-nimg="1"
            class="h-[350px] rounded-lg object-cover" style="color:transparent">
        </div>
