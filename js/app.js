...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var controlNavbar = function controlNavbar() {
...
document.addEventListener("DOMContentLoaded", function () {
  var targetTime = luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.fromISO("2025-09-10").setZone("Asia/Jakarta");
  var countdownElements = document.querySelectorAll(".countdown");
  var daysElements = document.querySelectorAll(".day");
  var hoursElements = document.querySelectorAll(".hour");
  var minutesElements = document.querySelectorAll(".minute");
  var secondsElements = document.querySelectorAll(".second");
  ...
  var updateCountdown = function updateCountdown() {
    var currentTime = luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.now().setZone("Asia/Jakarta");
    var diff = targetTime.toUnixInteger() - currentTime.toUnixInteger();
    var days = Math.floor(diff / 86400);
    var hours = Math.floor(diff % 86400 / 3600);
    var minutes = Math.floor(diff % 3600 / 60);
    var seconds = Math.floor(diff % 60);
    daysElements.forEach(function (element) {
      return element.textContent = days < 10 ? "0" + days : days;
    });
    hoursElements.forEach(function (element) {
      return element.textContent = hours < 10 ? "0" + hours : hours;
    });
    minutesElements.forEach(function (element) {
      return element.textContent = minutes < 10 ? "0" + minutes : minutes;
    });
    secondsElements.forEach(function (element) {
      return element.textContent = seconds < 10 ? "0" + seconds : seconds;
    });
  };
  var updateAllCountdowns = function updateAllCountdowns() {
    countdownElements.forEach(function (countdown) {
      return updateCountdown(countdown);
    });
  };
  updateAllCountdowns();
  var interval = setInterval(updateAllCountdowns, 1000);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkicait"] = self["webpackChunkicait"] || [];
